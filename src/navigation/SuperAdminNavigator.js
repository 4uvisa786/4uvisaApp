...
import SuperAdminManageServicesScreen from '../screens/SuperAdmin/SuperAdminManageServicesScreen';
...
const ICON_MAP = {
  Dashboard: 'dashboard',
  'SuperAdmin Services': 'inventory', // For managing the services (list of items/products)
...
function AdminTabs() {
  return (
    ...
    >
      ...
      <Tab.Screen name="SuperAdmin Services" component={SuperAdminManageServicesScreen} />
